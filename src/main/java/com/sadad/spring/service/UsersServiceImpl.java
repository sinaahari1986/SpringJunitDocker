...
import com.sadad.spring.exceptions.UsersServiceException;
import com.sadad.spring.model.UserEntity;
import com.sadad.spring.model.UsersRepository;
...
public class UsersServiceImpl implements UsersService {
    ...
    public UserDto deleteUserDto(long id) {
        ...
        if (usersRepository.findById(id) == null)
            throw new UsersServiceException("Record not found");

        usersRepository.deleteById(id);
        ModelMapper modelMapper = new ModelMapper();
        UserDto returnValue = modelMapper.map(usersRepository.findById(id), UserDto.class);
